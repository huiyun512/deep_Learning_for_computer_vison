...
orig = cv2.imread("D:\\PyCharm-project\\deep_Learning_for_computer_vison\\sub_code\\beagle.jpg")
...
# prediction
cv2.putText(orig, "Label:{}".format(labels[np.argmax(scores)]), (5, 30), cv2.FONT_HERSHEY_COMPLEX, 0.9, (0, 0, 255), 1)
